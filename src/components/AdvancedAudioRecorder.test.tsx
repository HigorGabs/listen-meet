...
describe('AdvancedAudioRecorder', () => {
  ...
  it('renders the studio recorder idle state', () => {
    ...
    expect(screen.getAllByText('Microfone Padrão').length).toBeGreaterThan(0)
    expect(screen.getByText('Tamanho')).toBeInTheDocument()
    expect(screen.getAllByText('0%').length).toBeGreaterThan(0)
    expect(screen.getByText('Modo de IA')).toBeInTheDocument()
    expect(screen.getByText('Pronto para gravar')).toBeInTheDocument()
  ...
  it('renders recorder controls in English when requested', () => {
    ...
    expect(screen.getAllByText('Default Microphone').length).toBeGreaterThan(0)
